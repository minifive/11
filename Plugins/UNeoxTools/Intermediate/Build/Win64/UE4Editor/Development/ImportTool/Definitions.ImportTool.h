...
#define ORIGINAL_FILE_NAME "UE4Editor-ImportTool.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME UneoxToolsPro
#define DEPRECATED_FORGAME DEPRECATED
#define IMPORTTOOL_API DLLEXPORT
...
#define PROJECTTARGETPLATFORMEDITOR_API 
